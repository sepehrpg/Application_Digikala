...
public class Api_Timer implements Config {
    ...
    public static void GetMethod_timer(Context context,final TextView Tv__sec,final TextView Tv_min, final TextView Tv_hour){
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(0, urlHome + "timer.php", null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                gethandlerMethod(Tv__sec,Tv_min,Tv_hour);
    ...
    public static void gethandlerMethod(final TextView Tv__sec,final TextView Tv_min, final TextView Tv_hour){
